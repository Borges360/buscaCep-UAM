<?php require_once("../controller/cadastroController.php");?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <fieldset>
        <div class="form-group">
            <form method="POST" action="../controller/cadastroController.php">
                ...
                <input class="form-control" type="text" id="logradouro" name="logradouro" placeholder="Logradouro*" required><br />
                ...
                <select class="form-control" id="uf" name="uf" placeholder="UF" required><br />
